						...
						<div style="display: none;">
							...
							<div class="row">
								...
								<div class="fourcol">
									...
									<span class="buy-button" id="id_'.$results['id'].'">Add to Cart</span></p><br /><br />
								</div>
									...
									if ($reviewed == 0)	{
										...
										<form action="" method="post" id="review-form">
											...
											<input type="hidden" id="theuser" value="'.$_SESSION['user'].'" name="theuser" style="display: none;" />
												...
												<textarea maxlength="255" placeholder="Write a review." name="review-text" id="review-text"></textarea><br />
